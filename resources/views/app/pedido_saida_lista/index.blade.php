...
<main class="content">
    <div class="card">
        ...
        <iframe id="ifm1" src="{{route('item-produto-saida.index',['pedido' => $pedido_saida_f->id,'empresa_id'=>$pedido_saida_f->empresa->id])}}" width="100%" height="600" style="border:1px solid black;">
        </iframe>
