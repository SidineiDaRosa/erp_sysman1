            ...
            <form action="{{ route('produto.update', ['produto' => $produto->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <form action="{{ route('produto.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-md-6">
                            <textarea id="descricao" name="descricao" rows="3" class="form-control" descricao="descricao" value="{{ $produto->descricao ?? old('descricao') }}" required autocomplete="descricao" autofocus></textarea>
