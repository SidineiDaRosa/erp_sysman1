            ...
            <form action="{{ route('Saida-produto.update', ['Saida_produto' => $saida_produto->id]) }}" method="POST">
                ...
                <form action="{{ route('Saida-produto.store') }}" method="POST">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-md-6">
                            <select name="produto_id" id="" class="form-control">
                                ...
                                <option value="{{ $produto->id }}" {{ ($produto->produto_id ?? old('produto_id')) == $produto->id ? 'selected' : '' }}>
                                    {{ $produto->nome }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input name="data" id="data" type="date" class="form-control " value="{{ $produto->data ?? old('data') }}">
