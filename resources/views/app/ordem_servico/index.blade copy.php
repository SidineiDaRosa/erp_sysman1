                    ...
                    <tr>
                        ...
                        <td>
                            <div {{-- class="div-op" --}} class="btn-group btn-group-actions visible-on-hover">
                                ...
                                <a class="btn btn-sm-template btn-outline-danger @can('user') disabled @endcan" href="{{route('ordem-servico.destroy', ['ordem_servico'=>$ordem_servico->id])}}" data-bs-toggle="modal" data-bs-target="#deleteModal">
