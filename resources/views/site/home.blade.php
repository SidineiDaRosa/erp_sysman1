...
<body>
        ...
        <div class="navbar" id="myNavbar">
            ...
            <a href="{{'e-comerce-show-produto'}}">PRODUTOS & SERVIÇOS</a>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-caption">
                <h1>A confiabilidade de sua produção, depende da manutenção de suas máquinas!</h1>
                <input type="button" value="Conheça o manuweb">
            </div>
        </div>
